					...
					<div class="card">
						<div class="card-body">
							<form:form class="form-horizontal" role="form" method="post"  
								action="/Estat/product/productEdit" enctype="multipart/form-data" modelAttribute="updateProduct">
								<h2>Registration</h2>
								<input type="hidden" name="vendor_id"
									value="${sessionScope.vendor_dtls.vendorId}" />
									<input type="hidden" name="pId"
									value="${requestScope.editProduct.pId}" />
								<div class="form-group">
									<label for="title" class="col-sm-3 control-label">Title</label>
									<div class="col-sm-9">
										<input type="text" id="title" placeholder="product title"
											name="title" class="form-control" value="${requestScope.editProduct.title}" autofocus>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<textarea id="description" class="form-control"
											name="description"  rows="5" cols="47">${requestScope.editProduct.description}</textarea>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<label>Category</label> <select name="category" id="category"
											class="form-control" value="${requestScope.editProduct.category}">
											<option value="${requestScope.editProduct.category} ">${requestScope.editProduct.category}</option>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="unitPrice" placeholder="unitPrice"
											name="unitPrice" class="form-control" value="${requestScope.editProduct.unitPrice}">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="stock" placeholder="In stock"
											name="stock" class="form-control" value="${requestScope.editProduct.stock}">
									</div>
								</div>
								<div class="form-group">
									...
									value="${requestScope.editProduct.imageName}" />
